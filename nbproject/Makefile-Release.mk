...
${OBJECTDIR}/proceso_datos.o: proceso_datos.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/proceso_datos.o proceso_datos.c
...
${TESTDIR}/tests/newcunittest7.o: tests/newcunittest7.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/newcunittest7.o tests/newcunittest7.c
...
${OBJECTDIR}/proceso_datos_nomain.o: ${OBJECTDIR}/proceso_datos.o proceso_datos.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/proceso_datos_nomain.o proceso_datos.c;\
	else  \
